...
### check_other_agents_work | Check Other Agents
...
### randomly_inspect_code | Random Inspection
...
### analyze_beads_and_allocate | Analyze Beads
...
### check_orm_and_schemas | Check ORM/Schemas
...
### scrutinize_and_improve_workflow_and_ui | Scrutinize Workflow/UI
...
### leverage_tanstack_libraries | Leverage TanStack
...
### complete_docusaurus_site | Complete Documentation
...
### add_missing_features_to_readme | Add Features to README
...
### combine_plans_into_hybrid | Combine Plans
...
### work_on_your_beads | Work on Beads
...
### start_out_with_agent_mail | Start with Mail
...
### read_agents_and_investigate | Read Agents & Investigate
